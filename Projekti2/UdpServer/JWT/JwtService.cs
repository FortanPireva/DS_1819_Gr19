...
namespace AuthenticationService.Managers
{
    public class JWTService : IAuthService
    {
        ...
        IEnumerable<Claim> IAuthService.GetTokenClaims { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        #endregion
        ...
        public string GenerateToken(JwtAuthContainerModel model)
        {
